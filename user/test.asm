...
int main(int argc, char *argv[])
{
  ...
  10:	2ca080e7          	jalr	714(ra) # 2d6 <fork>
    if (pid == 0)
  14:	cd05                	beqz	a0,4c <main+0x4c>
  for (int i = 0; i < 10; i++)
  16:	34fd                	addiw	s1,s1,-1
  18:	f8f5                	bnez	s1,c <main+0xc>
  1a:	3b9ad7b7          	lui	a5,0x3b9ad
  1e:	a0078793          	addi	a5,a5,-1536 # 3b9aca00 <base+0x3b9ab9f0>
    {
      break;
    }
  }
  ...
  2a:	338080e7          	jalr	824(ra) # 35e <getpid>
  2e:	85aa                	mv	a1,a0
  printf("%d pid is finished!!!\n", pid);
  30:	00000517          	auipc	a0,0x0
  34:	7e050513          	addi	a0,a0,2016 # 810 <malloc+0xec>
  38:	00000097          	auipc	ra,0x0
  3c:	62e080e7          	jalr	1582(ra) # 666 <printf>
  return 0;
  40:	4501                	li	a0,0
  42:	60e2                	ld	ra,24(sp)
  44:	6442                	ld	s0,16(sp)
  ...
  4a:	8082                	ret
  4c:	3b9ad7b7          	lui	a5,0x3b9ad
  50:	a0078793          	addi	a5,a5,-1536 # 3b9aca00 <base+0x3b9ab9f0>
  54:	b7f9                	j	22 <main+0x22>
